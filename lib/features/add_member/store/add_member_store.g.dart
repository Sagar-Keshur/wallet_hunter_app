...
mixin _$AddMemberStore on _AddMemberStore, Store {
  ...
  late final _$firstNameAtom = Atom(
    name: '_AddMemberStore.firstName',
    context: context,
  );
  ...
  late final _$middleNameAtom = Atom(
    name: '_AddMemberStore.middleName',
    context: context,
  );
  ...
  late final _$birthDateAtom = Atom(
    name: '_AddMemberStore.birthDate',
    context: context,
  );
  ...
  late final _$ageAtom = Atom(name: '_AddMemberStore.age', context: context);
  ...
  late final _$maritalStatusAtom = Atom(
    name: '_AddMemberStore.maritalStatus',
    context: context,
  );
  ...
  late final _$qualificationAtom = Atom(
    name: '_AddMemberStore.qualification',
    context: context,
  );
  ...
  late final _$occupationAtom = Atom(
    name: '_AddMemberStore.occupation',
    context: context,
  );
  ...
  late final _$exactNatureOfDutiesAtom = Atom(
    name: '_AddMemberStore.exactNatureOfDuties',
    context: context,
  );
  ...
  late final _$bloodGroupAtom = Atom(
    name: '_AddMemberStore.bloodGroup',
    context: context,
  );
  ...
  late final _$relationWithFamilyHeadAtom = Atom(
    name: '_AddMemberStore.relationWithFamilyHead',
    context: context,
  );

  @override
  String get relationWithFamilyHead {
    _$relationWithFamilyHeadAtom.reportRead();
    return super.relationWithFamilyHead;
  }

  @override
  set relationWithFamilyHead(String value) {
    _$relationWithFamilyHeadAtom.reportWrite(
      value,
      super.relationWithFamilyHead,
      () {
        super.relationWithFamilyHead = value;
      },
    );
  }

  late final _$phoneNumberAtom = Atom(
    name: '_AddMemberStore.phoneNumber',
    context: context,
  );
  ...
  late final _$alternativeNumberAtom = Atom(
    name: '_AddMemberStore.alternativeNumber',
    context: context,
  );
  ...
  late final _$landlineNumberAtom = Atom(
    name: '_AddMemberStore.landlineNumber',
    context: context,
  );
  ...
  late final _$socialMediaLinkAtom = Atom(
    name: '_AddMemberStore.socialMediaLink',
    context: context,
  );
  ...
  late final _$cityAtom = Atom(name: '_AddMemberStore.city', context: context);
  ...
  late final _$streetNameAtom = Atom(
    name: '_AddMemberStore.streetName',
    context: context,
  );
  ...
  late final _$buildingNameAtom = Atom(
    name: '_AddMemberStore.buildingName',
    context: context,
  );
  ...
  late final _$doorNumberAtom = Atom(
    name: '_AddMemberStore.doorNumber',
    context: context,
  );

  @override
  String get doorNumber {
    _$doorNumberAtom.reportRead();
    return super.doorNumber;
  }

  @override
  set doorNumber(String value) {
    _$doorNumberAtom.reportWrite(value, super.doorNumber, () {
      super.doorNumber = value;
    });
  }

  late final _$flatNumberAtom = Atom(
    name: '_AddMemberStore.flatNumber',
    context: context,
  );
  ...
  late final _$nativeCityAtom = Atom(
    name: '_AddMemberStore.nativeCity',
    context: context,
  );
  ...
  late final _$nativeStateAtom = Atom(
    name: '_AddMemberStore.nativeState',
    context: context,
  );
  ...
  void onNextPage() {
    final _$actionInfo = _$_AddMemberStoreActionController.startAction(
      name: '_AddMemberStore.onNextPage',
    );
    try {
  ...
  void onPreviousPage() {
    final _$actionInfo = _$_AddMemberStoreActionController.startAction(
      name: '_AddMemberStore.onPreviousPage',
    );
    try {
